// Centralized Management (Favicon & Analytics)
(function() {
    // 1. ANALYTICS: Google Analytics Setup
    const GA_ID = 'G-0JRTDTM7LC';
    ...
    // 2. CONFIGURATION: Change your favicon URL here
    // Option A: Use a professional SVG (Old)
    // Option B: Use an image file (Recommended)
    // Option C: Use an external URL (e.g., 'https://example.com/logo.png')
    
    // ✅ UPDATED: Using real favicon file (SEO friendly)
    const FAVICON_URL = '/favicon.ico';
    
    // 2. LOGIC: Injects the favicon into the head and updates logo images
    function setFavicon() {
